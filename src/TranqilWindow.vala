...
namespace Tranqil {
    ...
    public class TranqilWindow : Gtk.Dialog {
        ...
        public TranqilWindow (Gtk.Application application) {
            ...
            var first = tranqil_settings.get_boolean ("first-time");
        ...
        private string change_background_colour (){
          /*if(toggle_forest.active && toggle_night.active && toggle_waves.active && toggle_rain.active)
            return "#1F665D";*/
          /*if(toggle_forest.active && toggle_night.active && toggle_waves.active)
            return "#126972";
          if(toggle_forest.active && toggle_night.active && toggle_rain.active)
            return "#126972";
          if(toggle_forest.active && toggle_night.active)
            return "#32662C";*/
